package com.example.auth.server.demo.auth;

import com.example.auth.server.demo.user.CustomAuthUser;
import com.example.auth.server.demo.user.CustomAuthUserMixin;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public JpaOAuth2AuthorizationService(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
        ...
        this.objectMapper.addMixIn(CustomAuthUser.class, CustomAuthUserMixin.class);
    }
